...
class Exhibitionn extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_country','image', 'enable'], 'integer'],
//            [['file'],'file','extensions'=>'png,jpg,jpeg,gif,pdf'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'image' => 'عکس نمایشگاه',
            'holding_date' => 'تاریخ برگزاری',//چون تاریخ رو ما شمسی ذخیره میکنیم پس باید از نوع string باشد
            'holding_date_ir' => 'Holding Date Ir',//چون تاریه به صورت میلادی ذخیره میشود باید از نوع date باشد
    ...
    //برگرداندن اسم کشور ها در indexار زو فیلم هاله
