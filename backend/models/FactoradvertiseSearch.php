...
/**
 * FactoradvertiseSearch represents the model behind the search form of `backend\models\Factoradvertise`.
 */
class FactoradvertiseSearch extends Factoradvertise
{
    ...
    {
        return [
            [['id', 'volume', 'advertise', 'id_participant', 'price', 'visible', 'print', 'confirm', 'endPrice', 'enable'], 'integer'],
