...
//
            ...
            if ($category == null) {
echo "اول دسته بندی را تکمیل کنید";exit;
...
//                        $model->fileMove4 = UploadedFile::getInstance($model, 'fileMove4');
                        ...
                        //هجباری بودن عکس و فیلم محصول
                        if ($model->fileMove1 != null && $model->fileMove3 != null ) {
                            ...
                            if ($model->validate()) {
                                     ...
                                     $movies='-**-';
                                      foreach ($model->fileMove1 as $movie){
                                        ...
                                        //   $movie->saveAs(Yii::getAlias('@upload').'/upload/video'.$basename1.'.'.$movie->extension);
                                         $movie->saveAs('./../../upload/video/' . $basename1 . '.' . $movie->extension);
                                ...
                                if ($model->fileMove2 != null) {
                                    ...
                                    // $model->fileMove2->saveAs(Yii::getAlias('@upload') . '/upload/files/' . $basename2 . '.' . $model->fileMove2->extension);
                                      $model->fileMove2->saveAs('./../../upload/files/' . $basename2 . '.' . $model->fileMove2->extension);
                                ...
                                if ($model->fileMove3 != null) {
                                    ...
                                    $model->fileMove3->saveAs('./../../upload/images/'. $basename3 . '.' . $model->fileMove3->extension);
...
//اگر در جدول productMove فیلم محصول ثبت شده باشد
                                    if ($model->id_img != -1) {
                                        ...
                                        if ($move){
                                            ...
                                            if ($nModel->save()){}//end if $nModel save
                                            else{}//end else $nModel save
                                        }//end if $move
//                                        foreach ($move as $m) {
//                                            if ($m->id == $idPro) {
//                                                $images->id_product = $idPro;
//                                                $images->save();
//
//                                            }
//                                        }
//                                        echo 5;exit;
                                    }//end if 4model->image != -1 
                                    else {
//var_dump($images->getErrors());exit;
                                    }//end else 4model->image != -1 
                            ...
                            if ($model->fileMove1 != null) {
                                ...
                                if ($model->fileMove2 != null) {
                                    ...
                                    if ($model->fileMove2 != $move2) {
                                        ...
                                        $model->fileMove2->saveAs('./../../upload/files/'  . $basename . '.' . $model->fileMove2->extension);
...
//                        $move1 = $basename1 . '.' . $model->file1->extension;
                                ...
                                if ($model->fileMove3 != null) {
                                    ...
                                    if ($model->fileMove3 != $move3) {
                                        ...
                                        $model->fileMove3->saveAs('./../../upload/images/'. $basename . '.' . $model->fileMove3->extension);
...
//                if ($model->fileMove1 != null) {
//
//                    if ($model->fileMove1 != $move1) {
//
//                        $basename = $booth . 'Product' . $model->fileMove1->baseName;
//                        $model->fileMove1->saveAs(Yii::getAlias('@upload') . '/upload/video/' . $basename . '.' . $model->fileMove1->extension);
//                        $mov->move1 = $basename . '.' . $model->fileMove1->extension;
////                        $move1 = $basename1 . '.' . $model->file1->extension;
//                        $move1 = $mov->move1;
//
//                    }
//                } else {
//                    $move1 = $mov->move1 = $move1;
//                }
//
//                if ($model->fileMove2 != null) {
//
...
//
//                        $basename = $booth . 'Product' . $model->fileMove2->baseName;
//                        $model->fileMove2->saveAs(Yii::getAlias('@upload') . '/upload/video/' . $basename . '.' . $model->fileMove2->extension);
//                        $mov->move2 = $basename . '.' . $model->fileMove2->extension;
////                        $move1 = $basename1 . '.' . $model->file1->extension;
//                        $move2 = $mov->move2;
//
