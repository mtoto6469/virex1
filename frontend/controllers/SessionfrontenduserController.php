...
use frontend\models\SessionfrontenduserSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SessionfrontenduserController implements the CRUD actions for Sessionfrontenduser model.
 */
class SessionfrontenduserController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new SessionfrontenduserSearch();
