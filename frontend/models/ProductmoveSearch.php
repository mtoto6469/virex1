...
/**
 * ProductmoveSearch represents the model behind the search form of `frontend\models\Productmove`.
 */
class ProductmoveSearch extends Productmove
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'move1', $this->move1])
