...
class ProfileSearch extends Profile
{
    ...
    {
        return [
            [['id', 'id_user', 'state', 'id_img', 'rules', 'enable', 'first'], 'integer'],
            [['role', 'name', 'email', 'username', 'password', 'telephone', 'mobile', 'company_name_en', 'company_name_ir', 'date', 'date_ir', 'date_update', 'date_update_ir', 'code'], 'safe'],
        ];
    }
