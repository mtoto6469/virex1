...
class Yii2 extends Client
{
    ...
    /**
     * @var string[] List of components names that must be recreated before each request
     */
...
the response object, this means any behaviors or events that are not attached in the components config will be lost.
...
the request object, this means any behaviors or events that are not attached in the components config will be lost.
