...
class DbPanel extends Panel
{
    ...
    /**
     * @var string the name of the database components to use for executing (explain) queries
     */
    public $db = 'db';
    /**
    ...
    /**
     * @return bool Whether the DB components has support for EXPLAIN queries
     * @since 2.0.5
     */
    ...
    /**
     * Returns a reference to the DB components associated with the panel
     *
