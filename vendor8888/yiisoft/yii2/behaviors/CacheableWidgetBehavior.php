 ...
 *
 * The behavior may be used without any configuration if an application has `cache` components configured.
...
{
    /**
     * @var CacheInterface|string|array a cache object or a cache components ID
     * or a configuration array for creating a cache object.
     * Defaults to the `cache` application components.
     */
    public $cache = 'cache';
    /**
