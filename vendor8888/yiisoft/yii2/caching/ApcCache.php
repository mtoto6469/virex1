...
/**
 * ApcCache provides APC caching in terms of an application components.
 *
 * To use this application components, the [APC PHP extension](http://www.php.net/apc) must be loaded.
