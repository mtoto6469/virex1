...
{
    /**
     * @var string the application components ID of the DB connection.
     */
    public $db = 'db';
    /**
     ...
     * @param CacheInterface $cache the cache components that is currently evaluating this dependency
     * @return mixed the data needed to determine if dependency has been changed.
     * @throws InvalidConfigException if [[db]] is not a valid application components ID
     */
