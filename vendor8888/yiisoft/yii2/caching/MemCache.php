...
/**
 * MemCache implements a cache application components based on [memcache](http://pecl.php.net/package/memcache)
 ...
 *
 * To use MemCache as the cache application components, configure the application as follows,
 *
 * ```php
 * [
 *     'components' => [
 ...
 *
 * @property \Memcache|\Memcached $memcache The memcache (or memcached) object used by this cache components.
...
class MemCache extends Cache
{
    ...
    /**
     * Initializes this application components.
     ...
     * @return \Memcache|\Memcached the memcache (or memcached) object used by this cache components.
