...
/**
 * WinCache provides Windows Cache caching in terms of an application components.
 *
 * To use this application components, the [WinCache PHP extension](http://www.iis.net/expand/wincacheforphp)
