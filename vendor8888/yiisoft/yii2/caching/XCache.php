...
/**
 * XCache provides XCache caching in terms of an application components.
 *
 * To use this application components, the [XCache PHP extension](http://xcache.lighttpd.net/) must be loaded.
