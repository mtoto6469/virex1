...
/**
 * ZendDataCache provides Zend data caching in terms of an application components.
 *
 * To use this application components, the [Zend Data Cache PHP extension](http://www.zend.com/en/products/server/)
 * must be loaded.
 *
