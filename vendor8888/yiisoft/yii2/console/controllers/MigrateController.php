...
class MigrateController extends BaseMigrateController
{
    ...
    public $fields = [];
    /**
     * @var Connection|array|string the DB connection object or the application components ID of the DB connection to use
        ...
        foreach ($foreignKeys as $column => $foreignKey) {
            ...
            if ($relatedColumn === null) {
                ...
                try {
                    ...
                    $this->stdout("Cannot initialize database components to try reading referenced table schema for field \"{$column}\". Default name \"id\" will be used for related field.\n", Console::FG_YELLOW);
                }
            }
            $foreignKeys[$column] = [
