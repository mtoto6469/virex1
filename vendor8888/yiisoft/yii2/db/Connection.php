 ...
 *
 * Connection supports database replication and read-write splitting. In particular, a Connection components
 ...
 * ```
 *
 * Connection is often used as an application components and configured in the application
...
class Connection extends Component
{
     ...
     * Note that in order to enable truly schema caching, a valid cache components as specified
    ...
    /**
     * @var CacheInterface|string the cache object or the ID of the cache application components that
     ...
     * Note that in order to enable query caching, a valid cache components as specified
    ...
    /**
     * @var CacheInterface|string the cache object or the ID of the cache application components
    ...
    /**
     * @var CacheInterface|string|false the cache object or the ID of the cache application components that is used to store
