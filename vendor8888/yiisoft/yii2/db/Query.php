...
class Query extends Component implements QueryInterface, ExpressionInterface
{
     ...
     * If this parameter is not given, the `db` application components will be used.
     ...
     * @param Connection $db the database connection. If not set, the "db" application components will be used.
     ...
     * @param Connection $db the database connection used to generate the SQL statement.
     * If this parameter is not given (or null), the `db` application components will be used.
