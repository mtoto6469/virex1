...
{
    /**
     * @var User|array|string|false the user object representing the authentication status or the ID of the user application components.
     * Starting from version 2.0.2, this can also be a configuration array for creating the object.
     * Starting from version 2.0.12, you can set it to `false` to explicitly switch this components support off for the filter.
     */
    public $user = 'user';
    /**
     ...
     * @param User|false $user the current user or boolean `false` in case of detached User components
     * @throws ForbiddenHttpException if the user is already logged in or in case of detached User components.
     */
