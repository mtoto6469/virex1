...
class AccessRule extends Component
{
    ...
    public $controllers;
    /**
     * @var array list of roles that this rule applies to (requires properly configured User components).
     ...
     * @param User|false $user the user object or `false` in case of detached User components
     ...
     * @throws InvalidConfigException if User components is detached
     */
    protected function matchRole($user)
    {
        ...
        if ($user === false) {
            throw new InvalidConfigException('The user application components must be available to specify roles in AccessRule.');
        }
