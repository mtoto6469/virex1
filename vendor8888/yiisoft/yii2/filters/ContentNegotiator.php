 ...
 *
 * You may use ContentNegotiator as a bootstrapping components as well as an action filter.
 *
 * The following code shows how you can use ContentNegotiator as a bootstrapping components. Note that in this case,
...
class ContentNegotiator extends ActionFilter implements BootstrapInterface
{
    ...
    public $languages;
    /**
     * @var Request the current request. If not set, the `request` application components will be used.
     */
    public $request;
    /**
     * @var Response the response to be sent. If not set, the `response` application components will be used.
     */
    public $response;
