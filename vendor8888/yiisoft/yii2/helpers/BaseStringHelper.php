...
class BaseStringHelper
{
    ...
    /**
     * Returns the trailing name components of a path.
     ...
     * @param string $suffix If the name components ends in suffix this will also be cut off.
     * @return string the trailing name components of the given path.
