...
class DbMessageSource extends MessageSource
{
    ...
    /**
     * @var Connection|array|string the DB connection object or the application components ID of the DB connection.
     *
    ...
    /**
     * Initializes the DbMessageSource components.
     * This method will initialize the [[db]] property to make sure it refers to a valid DB connection.
     * Configured [[cache]] components would also be initialized.
