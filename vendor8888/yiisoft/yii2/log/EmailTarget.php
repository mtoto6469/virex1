 ...
 * ```
 *
 * In the above `mailer` is ID of the components that sends email and should be already configured.
 *
...
class EmailTarget extends Target
{
    ...
    public $message = [];
    /**
     * @var MailerInterface|array|string the mailer object or the application components ID of the mailer object.
