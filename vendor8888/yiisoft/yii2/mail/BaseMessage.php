 ...
 *
 * By default, [[send()]] will use the "mail" application components to send the current message.
 * The "mail" application components should be a mailer instance implementing [[MailerInterface]].
 *
 * @see BaseMailer
 *
...
abstract class BaseMessage extends BaseObject implements MessageInterface
{
     ...
     * the "mail" application components will be used instead.
