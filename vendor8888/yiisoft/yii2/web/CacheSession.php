...
/**
 * CacheSession implements a session components using cache as storage medium.
 *
 * The cache being used can be any cache application components.
 * The ID of the cache application components is specified via [[cache]], which defaults to 'cache'.
 *
 * Beware, by definition cache storage are volatile, which means the data stored on them
 * may be swapped out and get lost. Therefore, you must make sure the cache used by this components
...
{
    /**
     * @var CacheInterface|array|string the cache object or the application components ID of the cache object.
