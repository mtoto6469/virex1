 ...
 *
 * Finally, configure the "errorHandler" application components as follows,
 *
 * ```php
 * 'errorHandler' => [
...
class ErrorAction extends Action
{
    ...
    /**
     * Gets exception from the [[yii\web\ErrorHandler|ErrorHandler]] components.
     * In case there is no exception in the components, treat as the action has been invoked
