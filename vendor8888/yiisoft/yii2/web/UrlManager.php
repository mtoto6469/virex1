 ...
 *
 * UrlManager is configured as an application components in [[\yii\base\Application]] by default.
...
class UrlManager extends Component
{
    ...
    public $routeParam = 'r';
    /**
     * @var CacheInterface|string the cache object or the application components ID of the cache object.
     ...
     * @param Request $request the request components
