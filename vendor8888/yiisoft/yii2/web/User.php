...
/**
 * User is the class for the `user` application components that manages the user authentication status.
 *
 ...
 *
 * User is configured as an application components in [[\yii\web\Application]] by default.
...
class User extends Component
{
    ...
    /**
     * @var array MIME types for which this components should redirect to the [[loginUrl]].
     * @since 2.0.8
     */
     ...
     *
     * Note that you must configure "authManager" application components in order to use this method.
    ...
    /**
     * Returns auth manager associated with the user components.
     *
     * By default this is the `authManager` application components.
